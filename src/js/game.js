...
countStats = new Audio(
    "https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/Countupstats.mp3"
);
researchClick = new Audio(
    "https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/researchClick.mp3"
);
researchInactive = new Audio(
    "https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/researchInactive.mp3"
);
slideFast = new Audio(
    "https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/slideFast.mp3"
);
featuredModal = new Audio(
    "https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/featuredModal.mp3"
);
researchComplete = new Audio(
    "https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/researchComplete.mp3"
);
...
for (i = 0; i < 10; i++) {
    let a = new Audio(
        "https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/statAdd.mp3"
    );
...
$("body").on("click", ".share", () => {
    twShare(
        ...
        `I managed to get ${developer.followers.toLocaleString()} followers on the Codepen Simulator Game by @jamiecoulter89. https://bit.ly/2LyxS71 %23codepenSimGame`,
        520,
        350
    );
    return false;
...
${
  r.increaseHtml > 0
    ? `html <span class="green">+ ${r.increaseHtml}<img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/arrowUpStat.png"/></span><div class="sep"></div>`
    : ""
}
${
  r.increaseCss > 0
    ? `css <span class="green">+ ${r.increaseCss}<img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/arrowUpStat.png"/></span><div class="sep"></div>`
    : ""
}
${
  r.increaseJs > 0
    ? `js <span class="green">+ ${r.increaseJs}<img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/arrowUpStat.png"/></span><div class="sep"></div>`
    : ""
}
${
  r.increaseDesign > 0
    ? `design <span class="green">+ ${r.increaseDesign}<img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/arrowUpStat.png"/></span><div class="sep"></div>`
    : ""
}
<div class="research_button" data-index="${
    r.index
...
$(".researchButton").click(function () {
    ...
    $(".research_modal .item").each(function () {
        ...
        if (
            developer.followers >= research[index].cost &&
            research[index].researched == false
        ) {
...
$("body").on("click", ".research_button", function () {
    ...
    if (
        developer.followers > research[r].cost &&
        research[r].researched == false &&
        !globals.researching
    ) {
...
function keyPress() {
    ...
    if (globals.makingPen && progress < 100) {
        if (!globals.researching && !globals.paused) {
            ...
            let add =
                Math.floor(Math.random() * globals.penStatAddChance) +
                (globals.penStatAddChance - 2);
...
function makePip(stat, int, type) {
    $("body").append(
        `<div class="pip" data-type="${type}"><div class="pixelsTop"></div><div class="pixelsBottom"></div><p style="color:${stat};">${int}</p></div>`
    );
}
...
function release(p) {
    ...
    let newPen = {
        ...
        design: p.design,
        views: 0,
        maxViews: (Math.ceil((p.css + p.js + p.html + p.design) * globals.viewMultiplier) +
                1) *
            (pens.length + 1 / 35),
        dailyViews: (Math.ceil((p.css + p.js + p.html + p.design) * globals.viewMultiplier) +
                1) *
            (pens.length + 1 / 35),
        comments: 0,
        likes: 0,
    ...
    setTimeout(function () {
        $(".released").prepend(
            `<div class="released_pen" style="opacity:0"><div class="released_pen__top"><div class="pixelsTop"></div><div class="pixelsBottom"></div><span class="name">${
        pens[pens.length - 1].name
      }</span><div class="star"></div><div class="released_pen__graph"></div></div><div class="released_pen__bottom"><div class="pixelsTop"></div><div class="pixelsBottom"></div><img class="views" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/codepenViews.png" /><span class="view_count">${
        pens[pens.length - 1].views
      }</span><div class="sep"></div><img class="likes" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/codepenLikes.png" /><span class="like_count"> ${
        pens[pens.length - 1].likes
      }</span><div class="sep"></div><img class="comments" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/codepenComments.png" /><span class="comment_count"> ${
    ...
    if (!globals.paused) {
        ...
        $(".pip").each(function () {
            if ($(this).data("type") == "html") {
                $(this).animate({
                        left: rootStatElementPosition.html,
                        top: "140px"
                    },
                    2000,
                    function () {
            ...
            if ($(this).data("type") == "css") {
                $(this).animate({
                        left: rootStatElementPosition.css,
                        top: "140px"
                    },
                    1000,
                    function () {
            ...
            if ($(this).data("type") == "js") {
                $(this).animate({
                        left: rootStatElementPosition.js,
                        top: "140px"
                    },
                    1000,
                    function () {
            ...
            if ($(this).data("type") == "design") {
                $(this).animate({
                        left: rootStatElementPosition.design,
                        top: "140px"
                    },
                    1000,
                    function () {
        ...
        if (time > globals.timerTick) {
            ...
            $(".released_pen").each(function () {
                ...
                let height = Math.ceil(
                    (pens[index].dailyViews / pens[index].maxViews) * 100
                );
                ...
                if (pens[index].featured) {
                    $(this)
                        .find(".star")
                        .html(
                            '<img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/gStar.png" />'
                        );
                }
                if (height > 100) {
                    $(this)
                        .find(".released_pen__graph")
                        .append(
                            `<div class="line" style="height:${height}%; top:${0}%"></div>`
                        );
                } else {
                    $(this)
                        .find(".released_pen__graph")
                        .append(
                            `<div class="line" style="height:${height}%; top:${
                100 - height
              }%"></div>`
                        );
                }
            ...
            developer.followers += Math.floor(
                dailyFollowers /
                globals.followerFriction /
                ((developer.html + developer.css + developer.js + developer.design) /
                    10)
            );
